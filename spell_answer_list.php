...
<form method='post' name='form' action="spell_answer_list.php">
...
<?
	...
	$insert = "INSERT INTO $user_spell_db(id,date) VALUES('$user','$today')";
	$inquery = mysql_query($insert) or die(mysql_error());


	$myquery = "SELECT * FROM $user_spell_db WHERE id = '$user' AND end = '0'";
...
<input type='hidden' value="SpellPractice" name="mode">
